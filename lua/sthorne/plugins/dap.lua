...
local function configure()
  ...
  vim.keymap.set("n", "<F7>", "<CMD>lua require(\"sthorne.plugins.dap\").toggle_hover()<CR>")
  ...
  vim.keymap.set("n", "<S-F9>", "<CMD>lua require(\"dap\").clear_breakpoints()<CR>")
  vim.keymap.set("n", "<C-F9>", "<CMD>lua require(\"dap\").list_breakpoints()<CR>")
